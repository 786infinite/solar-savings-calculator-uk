export default function GuidePage() {
  const title = "How Long Do Solar Panels Take to Pay for Themselves?";
  const intro = "Solar panel payback depends on installation cost, electricity prices, export payments, self-consumption, and system performance.";
  const bullets = [
  "Higher electricity usage can improve the financial benefit.",
  "Using more solar electricity at home can reduce bills more than exporting it.",
  "Battery storage may increase self-consumption but also adds cost.",
  "The payback period should be treated as an estimate, not a guarantee."
];
