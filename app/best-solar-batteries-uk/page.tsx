export default function GuidePage() {
  const title = "Best Solar Batteries UK";
  const intro = "Solar batteries vary by capacity, warranty, power output, compatibility, and price.";
  const bullets = [
  "Battery capacity should match household usage.",
  "Power output matters if you want to run larger loads.",
  "Compatibility with your inverter and solar system is important.",
  "Compare battery cost against expected savings before buying."
];
