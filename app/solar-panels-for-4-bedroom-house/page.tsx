export default function GuidePage() {
  const title = "Solar Panels for a 4-Bedroom House";
  const intro = "A 4-bedroom house may need a larger solar system than a smaller property, especially with high electricity usage, EV charging, or battery storage.";
  const bullets = [
  "Larger homes often have higher electricity usage.",
  "Roof space and shading are important when sizing the system.",
  "EV charging can make solar more useful if charging happens during daylight.",
  "Installer quotes are needed to confirm final cost and suitability."
];
