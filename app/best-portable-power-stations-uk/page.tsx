export default function GuidePage() {
  const title = "Best Portable Power Stations UK";
  const intro = "Portable power stations can be useful for backup power, camping, garden offices, off-grid use, and emergency charging.";
  const bullets = [
  "Capacity matters if you want to run larger devices.",
  "Solar input matters if you plan to recharge from portable panels.",
  "Weight and portability are important for camping and travel.",
  "Warranty, battery chemistry, and output ports should be compared."
];
