export default function GuidePage() {
  const title = "How Much Do Solar Panels Cost in the UK?";
  const intro = "Solar panel costs in the UK vary depending on system size, roof suitability, battery storage, installer pricing, and product choice.";
  const bullets = [
  "System size and number of panels affect the total price.",
  "Battery storage can increase upfront cost but may improve self-consumption.",
  "Roof access, shading, direction, and scaffolding can affect the final quote.",
  "A proper installer survey is needed before relying on any exact figure."
];
