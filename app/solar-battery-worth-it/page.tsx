export default function GuidePage() {
  const title = "Is a Solar Battery Worth It?";
  const intro = "A solar battery may be worth it if you generate more solar electricity than you use during the day and want to use more of it later.";
  const bullets = [
  "Batteries can increase self-consumption.",
  "They are useful for evening usage, smart tariffs, and some EV households.",
  "They add upfront cost, so payback should be checked carefully.",
  "A battery is not automatically the best choice for every home."
];
