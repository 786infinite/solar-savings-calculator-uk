export default function GuidePage() {
  const title = "Are Solar Panels Worth It in the UK?";
  const intro = "Solar panels can be worth it for many UK homeowners, especially where the roof is suitable and electricity usage is high enough.";
  const bullets = [
  "They are usually more attractive for homeowners with higher electricity bills.",
  "They work best on roofs with good sunlight and limited shading.",
  "Battery storage can help if you use more electricity in the evening.",
  "The calculator can help estimate savings before comparing quotes."
];
