export default function GuidePage() {
  const title = "Solar Panels with Battery Cost UK";
  const intro = "Adding a battery to a solar panel system increases upfront cost but can help store unused solar electricity for later use.";
  const bullets = [
  "Batteries may help households that use more power in the evening.",
  "Battery size should match household usage and solar generation.",
  "Solar plus battery payback depends on tariffs, usage, and product cost.",
  "Compare solar-only and solar-plus-battery quotes before deciding."
];
