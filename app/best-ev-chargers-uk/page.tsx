export default function GuidePage() {
  const title = "Best EV Chargers UK";
  const intro = "The best EV charger depends on your car, home electricity setup, smart charging needs, solar compatibility, and installation cost.";
  const bullets = [
  "Smart charging can help schedule charging at cheaper times.",
  "Some EV chargers can work well with solar panels.",
  "Tethered chargers have a built-in cable, while untethered chargers use a separate cable.",
  "Professional installation is normally required."
];
