export default function GuidePage() {
  const title = "Best Solar Panels UK";
  const intro = "The best solar panels depend on efficiency, warranty, installer availability, roof space, budget, and long-term reliability.";
  const bullets = [
  "Higher efficiency panels can help where roof space is limited.",
  "Warranty and product support matter.",
  "Panel choice should be considered alongside inverter and installation quality.",
  "The cheapest panel is not always the best overall system choice."
];
