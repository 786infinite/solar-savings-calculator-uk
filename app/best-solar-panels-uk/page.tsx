...
export const metadata: Metadata = {
  ...
  description:
    "Compare solar panel types, efficiency, warranties, installation quality, roof suitability, batteries, EV charging, and how to choose solar panels.",
};
      ...
      <main className="min-h-screen bg-slate-950 text-white">
        <article className="mx-auto max-w-5xl px-6 py-16">
          ...
          <section className="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
              <h2 className="text-2xl font-bold">Warranty and performance</h2>
          ...
          <section className="mt-12 rounded-3xl border border-emerald-400/20 bg-emerald-400/10 p-6">
            <h2 className="text-3xl font-bold">Compare solar panel quotes</h2>
          ...
          <section className="mt-12 rounded-3xl border border-white/10 bg-white/5 p-6">
            <h2 className="text-3xl font-bold">
              View solar products at Sunstore
            </h2>

            <p className="mt-4 max-w-3xl leading-7 text-slate-300">
              If you are researching solar panels, off-grid solar kits,
              batteries, inverters, charge controllers, or solar accessories,
              Sunstore is one solar product supplier you can compare. This is
              separate from getting a full home installation quote.
            </p>
          ...
          <section className="mt-12 rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-4 max-w-3xl leading-7 text-slate-300">
              The free SolarCal guide helps you understand solar savings, quote
              comparison, payback periods, battery options, and common buying
              mistakes. If you want a more detailed checklist before choosing an
              installer, the Buyer’s Pack gives you extra quote comparison help
              and practical questions to ask.
            </p>
