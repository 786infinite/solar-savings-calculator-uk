export default function GuidePage() {
  const title = "Best Solar Generators UK";
  const intro = "Solar generators usually combine a portable power station with solar panels, giving a flexible option for backup or off-grid power.";
  const bullets = [
  "Check battery capacity and solar charging speed.",
  "Look at AC output if you want to power household devices.",
  "Portable systems are not the same as a full roof solar installation.",
  "They may suit renters or people not ready for full solar panels."
];
