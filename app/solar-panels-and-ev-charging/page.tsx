export default function GuidePage() {
  const title = "Solar Panels and EV Charging";
  const intro = "Solar panels can help charge an EV, especially when the car is at home during daylight hours or paired with smart charging.";
  const bullets = [
  "Daytime charging can make better use of solar generation.",
  "A battery may help store solar energy for later EV charging.",
  "EV usage can increase the value of a larger solar system.",
  "A smart EV charger can improve control and scheduling."
];
